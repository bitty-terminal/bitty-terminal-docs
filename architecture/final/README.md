...
| `03-panel-system.svg`        | [`../interactive/03-panel-system.html`](../interactive/03-panel-system.html)               | L1    | Window, Workspace, LayoutTree, Views, Panel Runtime + candidate Event-Sourced model |
