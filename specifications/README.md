...
| [Plugin API v1 Lua Surface RFC](https://github.com/bitty-terminal/bitty-plugins-docs/blob/main/specifications/plugin-api-v1-lua-surface-rfc.md)      | OQ-011 (surface spelling refinement)                                          | Accepted |
| [Plugin Host Runtime RFC](https://github.com/bitty-terminal/bitty-plugins-docs/blob/main/specifications/plugin-host-runtime-rfc.md)                  | OQ-033, OQ-034, OQ-035                                                        | Accepted |
...
| [Plugin Reuse and Provider Ecology RFC](https://github.com/bitty-terminal/bitty-plugins-docs/blob/main/specifications/plugin-reuse-and-providers.md) | OQ-011, OQ-012, OQ-013 (provider follow-up)                                   | Draft    |
...
| [UI Extensibility Architecture](https://github.com/bitty-terminal/bitty-plugins-docs/blob/main/specifications/ui-extensibility-architecture.md)      | OQ-043/OQ-044/OQ-049 (OQ-041/OQ-045 accepted in RFC-0001)                                     | Draft  | none (design review, no implementation, docs CTX-0157; OQ-041 per-View override and OQ-045 outline width accepted 2026-09-12 under docs CTX-0163; OQ-042 background-image contract accepted in RFC-0001) | P1 — panel/appearance extensibility                                          |
