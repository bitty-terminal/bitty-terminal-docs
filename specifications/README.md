...
| [Phodopus Host ABI (Candidate)](phodopus-host-abi-candidate.md)                                                                                  | OQ-009/OQ-030 (owner-pending; candidate, no new OQ)                                           | Draft  | none (design record only, no implementation, CTX-0044)                                                                                                                                                   | P2 — successor Lua runtime host-ABI direction; `bitty-lua` implementation deferred |
...
| [Ligature Decision](ligature-decision.md)                                                                                                        | M1-22 / bitty#1148; OQ-073 (owner-pending)                                                    | Draft  | none (no `ligature` matches under `crates/`; recorded recommendation only, CTX-0045)                                                                                                                     | P2 — recommend recorded refusal; OQ-073 closure path stated                        |
